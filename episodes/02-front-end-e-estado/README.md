...
- Didática por analogia operacional: cada conceito do front vira analogia do mundo fisico
- Conceito só entra se responde "o que quebra se isso faltar"
- Termina conectando com a série: o estado que precisa sobreviver vai para o servidor (ponte para o episodio 03)
