...
**Eixo:** narrativa única linear. A história de uma conversa: o navegador pede, o servidor responde. Cada conceito (request, metodo, endpoint, JSON, contrato, status code) explicado no momento em que aparece no dialogo.

**Não e:** manual de protocolo HTTP, comparacao de frameworks, curso de REST. E o oposto de uma referencia técnica. Aqui e a conversa invisivel entre front e servidor, contada como história.

**Público:** quem esta comecando com desenvolvimento / vibe coders / pessoas que usam IA para programar mas não fazem ideia do que acontece quando o navegador pede algo ao servidor.

**Duracao alvo:** 15-20 min.

**Episodio anterior:** 01 - Deploy do Zero ao Ar (o mapa geral).
**Próximo episodio:** 04 - Banco de dados (de onde o servidor tira os dados que devolve).
