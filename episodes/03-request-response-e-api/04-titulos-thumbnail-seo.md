...
Duas pontas visuais com o dialogo no meio:
- Esquerda: icone de navegador / tela de computador
- Centro: duas setas grandes, uma indo (REQUEST) e uma voltando (RESPONSE)
- Direita: icone de servidor / nuvem

Texto sobre a imagem: "REQUEST -> RESPONSE" ou "O que viaja no clique?"

### Cores

Fundo escuro (preto/azul escuro). Setas em cores diferentes: ida em amarelo, volta em verde-limao. Destacar "GET" e "POST" em um canto. Evitar poluicao visual.
...
#request #response #api #vibecoding #ia"
